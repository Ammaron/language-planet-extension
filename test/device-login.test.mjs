...
test('popup and onboarding open the device connection tab without credential fields', async () => {
  for (const [htmlPath, jsPath] of [['popup/popup.html', 'popup/popup.js'], ['popup/onboarding.html', 'popup/onboarding.js']]) {
...
test('connection and privacy copy is localized in English and Spanish', async () => {
  ...
  for (const key of ['connectLangslyAccount', 'connectBrowserTitle', 'connectPrivacyBody', 'sensitiveProtectionLocked']) {
